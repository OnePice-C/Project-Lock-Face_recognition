...
{
	if      (num==0) ST7789_WriteString(x, y, "0", Font_16x26, color, bgcolor);
	else if (num==1) ST7789_WriteString(x, y, "1", Font_16x26, color, bgcolor);
	else if (num==2) ST7789_WriteString(x, y, "2", Font_16x26, color, bgcolor);
	else if (num==3) ST7789_WriteString(x, y, "3", Font_16x26, color, bgcolor);
	else if (num==4) ST7789_WriteString(x, y, "4", Font_16x26, color, bgcolor);
	else if (num==5) ST7789_WriteString(x, y, "5", Font_16x26, color, bgcolor);
	else if (num==6) ST7789_WriteString(x, y, "6", Font_16x26, color, bgcolor);
	else if (num==7) ST7789_WriteString(x, y, "7", Font_16x26, color, bgcolor);
	else if (num==8) ST7789_WriteString(x, y, "8", Font_16x26, color, bgcolor);
	else if (num==9) ST7789_WriteString(x, y, "9", Font_16x26, color, bgcolor);
}
